          ...
          PCrearCuentaMedico5(
            ...
            birthDateController: birthDateController,
             ...
             emailController: emailController,
              ...
              codigoController:codigoController,
              irAPantalla: _irAPantalla, // Añade esta línea
              keys:keys,
          ),
        ];
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Info Personal'),
...
class PCrearCuentaMedico5 extends StatelessWidget {
  ...
  final TextEditingController emailController;
    ...
    final List<TextEditingController> yearControllers;
    final TextEditingController codigoController;
    final PageController pageController; // Añade este parámetro
 final Function(int) irAPantalla; // Añade este parámetro para navegación
...
bool validarCampos() {
  ...
  if (nombreController.text.isEmpty ||
      ...
      confirmPasswordController.text.isEmpty ||
      phoneController.text.isEmpty ) {
    debugPrint('Por favor complete todos la información personal');
     irAPantalla(0); // Ir a pantalla de info personal

    return false;
  }

  if (cantidadCedulasController.text.isEmpty || codigoController.text.isEmpty) {
    debugPrint('Por favor ingrese un numero de cedula');
     irAPantalla(1); // Ir a pantalla de profesion
    return false;
  }

    if ( codigoController.text.isEmpty) {
    debugPrint('Por favor ingrese un código de activación');
         irAPantalla(2); // Ir a pantalla de codigo
    return false;
  }
  // Verificar contraseñas coinciden
  if (passwordController.text != confirmPasswordController.text) {
    debugPrint('Las contraseñas no coinciden');
    //me voy a la de info personal
         irAPantalla(0); // Ir a pantalla de info personal
    return false;
  }
...
int band=0;
  ...
  if (band==1){
     debugPrint('Por favor complete todos los datos de las cédulas');
          irAPantalla(1); // Ir a pantalla de info personal
  }
  return true;
}
